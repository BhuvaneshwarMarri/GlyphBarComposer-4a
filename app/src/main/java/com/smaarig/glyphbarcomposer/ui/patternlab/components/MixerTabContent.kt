        ...
        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
            ...
            Row(
                ...
                ModeButton(
                    ...
                    !uiState.isLayered,
                    Modifier.weight(1f)
                ) { viewModel.onMergeModeChange(false) }
                ModeButton(
                    "Layered",
                    uiState.isLayered,
                    Modifier.weight(1f)
            ...
            Surface(
                ...
                Column(Modifier.padding(20.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
                    ...
                    if (uiState.blendMode == LabBlendMode.CROSSFADE) {
                        LabSliderRow(
                            "Ratio",
                            "${(uiState.crossfadeRatio * 100).toInt()}%",
                            uiState.crossfadeRatio,
                            0f..1f,
                            onValueChange = viewModel::onCrossfadeRatioChange
                        )
                    }
                    ...
                    LabSliderRow(
                        "Delay B",
                        "${uiState.offsetB}ms",
                        uiState.offsetB.toFloat(),
                        0f..1000f,
                        steps = 20,
                        onValueChange = { viewModel.onOffsetBChange(it.toInt()) })
                }
            }
        }
